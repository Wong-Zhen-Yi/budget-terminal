...
- The output is a single versioned executable such as `BudgetTerminal-v0.8.exe` under `dist\`.
...
That regenerates the versioned executable in `dist\`, for example `dist\BudgetTerminal-v0.8.exe`.

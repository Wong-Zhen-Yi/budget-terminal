...
class MarketDataTaskRunner:
    ...
    def __init__(
        ...
        *,
        ...
        self._executor = executor or ThreadPoolExecutor(
            ...
            thread_name_prefix="BudgetTerminalMarketData",
        )
        self._owns_executor = executor is None
        self._closed = False

    def shutdown(self, *, wait: bool = False) -> None:
        """Release executor resources owned by this runner."""
        if self._closed:
            return
        self._closed = True
    ...
    def __enter__(self) -> "MarketDataTaskRunner":
        return self
    ...
    def _call_with_timeout(self, fn: Callable[[], Any], timeout_seconds: float) -> Any:
        if self._closed:
            raise RuntimeError("market data task runner is closed")

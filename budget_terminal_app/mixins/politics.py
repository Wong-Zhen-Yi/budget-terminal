...
class PoliticsMixin:
    ...
    def init_page15(self) -> None:
        ...
        self.p15_trades_table.horizontalHeader().setStretchLastSection(True)
        ...
        self.p15_top_tickers_table.horizontalHeader().setStretchLastSection(True)
        self.p15_top_tickers_table.cellDoubleClicked.connect(self._p15_on_summary_ticker_dblclick)
        tickers_group_layout.addWidget(self.p15_top_tickers_table)
        right_layout.addWidget(tickers_group)
        ...
        self.p15_top_politicians_table.horizontalHeader().setStretchLastSection(True)
        self.p15_top_politicians_table.cellDoubleClicked.connect(self._p15_on_summary_politician_dblclick)
        politicians_group_layout.addWidget(self.p15_top_politicians_table)
        right_layout.addWidget(politicians_group)
    ...
    def _p15_on_data(self, result: dict) -> None:
        ...
        self._p15_populate_summary(result.get('top_tickers', []), result.get('top_politicians', []))
        self._p15_update_page_buttons()
    ...
    def _p15_populate_summary(self, top_tickers: list, top_politicians: list) -> None:
    ...
    def _p15_navigate_to_dashboard(self, ticker: str) -> None:
        if hasattr(self, 'dashboard_symbol_input'):
            self.dashboard_symbol_input.setText(ticker)
            if hasattr(self, '_dashboard_load_from_input'):
                self._dashboard_load_from_input()
            self.switch_page(0)
    ...
    def _apply_politics_theme(self) -> None:
        ...
        for table in (self.p15_trades_table, self.p15_top_tickers_table, self.p15_top_politicians_table):

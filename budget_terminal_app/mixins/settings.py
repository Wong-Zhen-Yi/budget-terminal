...
class SettingsMixin:
    ...
    def init_page9(self) -> None:
        ...
        self.settings_status_label.setMinimumHeight(22)
    ...
    def _build_settings_header(self) -> QFrame:
        ...
        self.settings_header_badge.setMinimumHeight(30)
    ...
    def _build_settings_preferences_box(self) -> QGroupBox:
        ...
        self.settings_theme_combo.setMinimumHeight(34)
        ...
        self.set_theme_role(self.settings_theme_preview, 'accent')
        self.settings_theme_preview.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.settings_theme_preview.setMinimumHeight(34)
        self.settings_timezone_combo = QComboBox()
        self.settings_timezone_combo.setMinimumHeight(34)
    ...
    def _build_settings_data_health_box(self) -> QGroupBox:
        ...
        data_health_layout.setContentsMargins(16, 18, 16, 16)
        data_health_layout.setSpacing(10)
        ...
        self.settings_data_health_refresh_btn.setMinimumHeight(32)
        ...
        self.settings_data_health_copy_btn.setMinimumHeight(32)
        ...
        self.settings_data_health_report.setMinimumHeight(180)
    ...
    def _build_settings_logs_box(self) -> QGroupBox:
        ...
        logs_layout.setContentsMargins(16, 18, 16, 16)
        ...
        self.settings_log_pause_btn.setMinimumHeight(32)
        ...
        self.settings_log_clear_btn.setMinimumHeight(32)
        ...
        self.settings_log_output.setMinimumHeight(280)
    ...
    def _build_settings_startup_performance_box(self) -> QGroupBox:
        ...
        startup_layout.setContentsMargins(16, 18, 16, 16)
        ...
        self.settings_startup_refresh_btn.setMinimumHeight(32)
        ...
        self.settings_startup_clear_btn.setMinimumHeight(32)
        ...
        self.settings_startup_history_output.setMinimumHeight(130)
    ...
    def _build_settings_shortcuts_box(self) -> Any:
        ...
        shortcuts_layout.setContentsMargins(16, 18, 16, 16)
        ...
        for row_index, (shortcut, behavior) in enumerate(self.SETTINGS_SHORTCUT_ROWS, start=1):
            ...
            shortcut_label.setMinimumHeight(30)

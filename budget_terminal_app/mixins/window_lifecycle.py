...
class WindowLifecycleMixin:
    ...
    def resizeEvent(self, event: Any) -> None:
        ...
        if (
            ...
            if self._is_current_page(getattr(self, 'page7', None)):
                if hasattr(self, '_p7_apply_monthly_responsive_layout'):
    ...
    def _warm_startup_etf_heatmap(self) -> None:
        ...
        if not self._startup_work_can_run():
            return
        self._ensure_page_initialized(6)
        self._call_if_page_initialized('_p17_request_all_etfs', page_attr='page17')
    ...
    def _warm_startup_etf_holdings(self) -> None:
        ...
        def _run() -> None:
            try:
                ...
                EtfHoldingsService().load(ticker)
    ...
    def _run_startup_data_start(self) -> None:
        ...
        if self._page_initialized(index=25):
    ...
    def _ensure_page_initialized(self, index: Any) -> bool:
        ...
        return self._page_initialized(index=index)
    ...
    def _refresh_current_page(self) -> None:
        ...
        if current_index == 25:
            ...
            return
        if current_index == 28:
            if hasattr(self, '_p29_refresh_performance'):
        ...
        if current_index == 19:
            ...
            return
        if current_index == 33:
            if hasattr(self, '_p34_request_news_refresh'):
                self._p34_request_news_refresh()
            return
        if current_index == 29:
        ...
        if current_index == 9:
            ...
            return
        if current_index == 27:
            if hasattr(self, '_p28_load'):
                self._p28_load(force_refresh=True)
            return
        if current_index == 11:
    ...
    def closeEvent(self, event: Any) -> None:
        ...
        for cleanup_name in ('_p36_stop',):
            ...
            try:
                ...
                logger.exception('Shutdown cleanup failed: %s.', cleanup_name)

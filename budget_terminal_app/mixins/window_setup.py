...
class WindowSetupMixin:
    ...
    def _setup_window_shell(self, root_layout: Any) -> None:
        ...
        for button in [self.btn_page1, self.btn_page4, self.btn_page6, self.btn_page7, self.btn_page3, self.btn_page8, self.btn_page10, self.btn_page11, self.btn_page2, self.btn_page5, self.btn_page9]:
    ...
    def _init_dashboard_page(self) -> None:
        ...
        self.dashboard_portfolio_combo.setMinimumWidth(150)
        ...
        port_header.addWidget(self.dashboard_portfolio_combo)

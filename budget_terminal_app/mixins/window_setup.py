...
class WindowSetupMixin:
    ...
    def _init_dashboard_page(self) -> None:
        ...
        self.port_table.horizontalHeader().setMinimumHeight(28)
        self.port_table.horizontalHeader().setDefaultSectionSize(28)
        ...
        self.port_table.horizontalHeader().setSectionResizeMode(5, QHeaderView.ResizeMode.Fixed)
        self.port_table.setColumnWidth(5, 28)
        ...
        for slot_index in range(3):
            ...
            self.set_theme_role(chart_label, 'muted')
            control_row.addWidget(chart_label)
            ...
            opt_table.horizontalHeader().setMinimumHeight(28)
            opt_table.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
            opt_table.verticalHeader().setDefaultSectionSize(24)
            opt_table.setAlternatingRowColors(True)
            options_label = QLabel('Top Options by Volume')
            self.set_theme_role(options_label, 'section_title')
            opt_container.addWidget(options_label)

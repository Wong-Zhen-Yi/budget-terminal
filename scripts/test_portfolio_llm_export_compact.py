...
def test_compact_portfolio_llm_export() -> None:
    ...
    _assert("Margin Debt: $30.00" in text, "margin debt should be explicit")
    _assert("Total Portfolio Value: $150.00" in text, "total portfolio value should exclude margin debt")

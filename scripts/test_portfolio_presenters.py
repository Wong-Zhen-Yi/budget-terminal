...
def test_market_cap_helpers() -> None:
    ...
    etf_size = {"quote_type": "ETF", "size_type": "aum", "size_value": 42_500_000_000}
    _assert(format_market_cap(etf_size) == "AUM $42.50B", "ETF size should be labelled as AUM")
    _assert(market_cap_sort_value(etf_size) == 42_500_000_000, "ETF AUM should retain numeric sorting")


def test_etf_analyst_target_is_not_applicable() -> None:
    row = build_portfolio_stock_row(
        "IAU",
        {"price": 77.0},
        default_color="#dddddd",
    ...
    _assert(row[P4_PORTFOLIO_COL_ANALYST_PT].text == "N/A", "ETF analyst target should be explicitly not applicable")
...
def main() -> None:
    ...
    test_etf_analyst_target_is_not_applicable()
